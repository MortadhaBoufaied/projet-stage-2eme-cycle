...
2. **Agent 1 â€” Cashflow / Revenue Forecast Agent**: Multi-horizon time-series forecasting model combining lag features, rolling statistics, calendar dynamics, and boosted trees (XGBoost/LightGBM) to forecast revenue, detect abnormal declines, and generate stockout alerts.
3. **Agent 2 â€” Credit Default / Payment Risk Assessment Agent**: High-precision risk scoring and classification model (Logistic Regression baseline & Boosted Classifier) with SHAP (SHapley Additive exPlanations) driver analysis.
...
- **Scale**: **72,000 daily entries** (10 Stores Ã— 10 Products Ã— 720 Days / 2 Years).
- **Primary Schema**:
...
### Agent 1 â€” Revenue / Cashflow Forecast Agent
...
### Agent 2 â€” Payment Risk Assessment Agent
